...
@set distrolibs=%distro%lib/;%distro%lib/xmlresolver-5.2.0.jar;%distro%lib/commons-fileupload-1.3.3.jar;%distro%lib/classindex-3.3.jar;%distro%lib/htmlparser-1.4.jar;%mailext%;%distro%xmlcalabash-1.3.2-100.jar;%distro%lib/slf4j-simple-1.7.32.jar;%distro%lib/slf4j-api-1.7.32.jar
