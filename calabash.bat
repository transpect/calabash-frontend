...
@set distrolibs=%distro%lib/;%distro%lib/xmlresolver-1.0.4.jar;%distro%lib/commons-fileupload-1.3.3.jar;%distro%lib/classindex-3.3.jar;%distro%lib/htmlparser-1.4.jar;%mailext%;%distro%xmlcalabash-1.2.1-99.jar;%distro%lib/log4j-api-2.17.1.jar;%distro%lib/log4j-core-2.17.1.jar;%distro%lib/log4j-slf4j-impl-2.17.1.jar;%distro%lib/slf4j-api-1.7.32.jar
