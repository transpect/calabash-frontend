...
if [ -z $CFG ]; then
    CFG=$EXT_BASE/ltx/ltx-config.xml
fi
...
CLASSPATH="$SAXON_JAR:$EXT_BASE/ltx/ltx-validate-with-rng/jing.jar:$DISTRO/xmlcalabash-1.1.0-96.jar:$DISTRO/lib/:$DISTRO/lib/xmlresolver.jar:$DISTRO/lib/htmlparser-1.4.jar:$PROJECT_DIR/adaptions/common/calabash:$DISTRO/lib/org.restlet.jar:$EXT_BASE/ltx/ltx-validate-with-rng/:$EXT_BASE/ltx/ltx-unzip/:$EXT_BASE/ltx/ltx-image-identify:$EXT_BASE/ltx/ltx-image-identify/commons-imaging-1.0-SNAPSHOT.jar:$EXT_BASE/ltx/ltx-image-identify/xmlgraphics-commons-1.5.jar:$EXT_BASE/fop/fop.jar:$DISTRO/lib/tagsoup-1.2.1.jar:$CLASSPATH"
