...
IMAGEPROPS_EXT="$EXT_BASE/transpect/image-props-extension:$EXT_BASE/transpect/image-props-extension/lib/commons-imaging-1.0-SNAPSHOT.jar:$EXT_BASE/transpect/image-props-extension/lib/xmlgraphics-commons-1.5.jar"
...
JAVASCRIPT_EXT="$EXT_BASE/transpect/javascript-extension:$EXT_BASE/transpect/javascript-extension/lib/trireme.0.8.9.jar:$EXT_BASE/transpect/javascript-extension/lib/js.jar"

EPUBCHECK_EXT="$EXT_BASE/transpect/epubcheck-extension/lib/common-image-3.1.2.jar:$EXT_BASE/transpect/epubcheck-extension/lib/common-io-3.1.2.jar:$EXT_BASE/transpect/epubcheck-extension/lib/common-lang-3.1.2.jar:$EXT_BASE/transpect/epubcheck-extension/lib/commons-compress-1.5.jar:$EXT_BASE/transpect/epubcheck-extension/lib/epubcheck_saxon-9.7.0.15.jar:$EXT_BASE/transpect/epubcheck-extension/lib/guava-14.0.1.jar:$EXT_BASE/transpect/epubcheck-extension/lib/imageio-core-3.1.2.jar:$EXT_BASE/transpect/epubcheck-extension/lib/imageio-jpeg-3.1.2.jar:$EXT_BASE/transpect/epubcheck-extension/lib/imageio-metadata-3.1.2.jar:$EXT_BASE/transpect/epubcheck-extension/lib/jackson-core-asl-1.9.12.jar:$EXT_BASE/transpect/epubcheck-extension/lib/jackson-mapper-asl-1.9.12.jar:$EXT_BASE/transpect/epubcheck-extension/lib/jing-20120724.0.0.jar:$EXT_BASE/transpect/epubcheck-extension/lib/sac-1.3.jar:$EXT_BASE/transpect/epubcheck-extension"

CLASSPATH="$ADAPTATIONS_DIR/common/saxon/:$SAXON_JAR:$DIR/saxon/:$EXT_BASE/transpect/rng-extension/jing.jar:$DISTRO/xmlcalabash-1.1.15-97.jar:$DISTRO/lib/:$DISTRO/lib/xmlresolver-0.12.3.jar:$DISTRO/lib/htmlparser-1.4.jar:$PROJECT_DIR/a9s/common/calabash:$DISTRO/lib/org.restlet-2.2.2.jar:$EXT_BASE/transpect/rng-extension/:$EXT_BASE/transpect/unzip-extension/:$DISTRO/lib/tagsoup-1.2.1.jar:$DISTRO/lib/xmlprojector-1.4.8.jar:$EPUBCHECK_EXT:$JAVASCRIPT_EXT:$IMAGEPROPS_EXT:$IMAGETRANSFORM_EXT:$CLASSPATH"
