...
DISTROLIBS="$DISTRO/lib/:$DISTRO/lib/xmlresolver-1.0.4.jar:$DISTRO/lib/commons-fileupload-1.3.3.jar:$DISTRO/lib/classindex-3.3.jar:$DISTRO/lib/htmlparser-1.4.jar:$PROJECT_DIR/a9s/common/calabash:$DISTRO/lib/org.restlet-2.2.2.jar:$MAIL_EXT:$DISTRO/lib/tagsoup-1.2.1.jar:$DISTRO/lib/slf4j-api-1.7.32.jar:$DISTRO/lib/log4j-api-2.15.0.jar:$DISTRO/lib/log4j-core-2.15.0.jar:$DISTRO/lib/log4j-slf4j-impl-2.15.0.jar"
